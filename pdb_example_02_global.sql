...
where dbid in (db_id('TwoWestGate'),db_id('SunsetDB'),db_id('VeniceDB'),db_id('WilshireDB'),db_id('TwoWestGlobalDB')) and cmd = 'AWAITING COMMAND' and spid <> @@spid;
exec(@sql);
end;
go
...
create table Branches
	(	BranchId			PartitionDBType			not null primary key
...
create table Roles
	...
	,	BranchId			PartitionDBType			not null references Branches (BranchId)
...
insert into PdbBranches (BranchId,BranchNumber,Name,City,Address,PostalCode) values (1,'101','Sunset','Los Angeles, CA','Sunset Blvd','90189');
insert into PdbBranches (BranchId,BranchNumber,Name,City,Address,PostalCode) values (2,'102','Venice','Los Angeles, CA','Washington Blvd, Venice','90291');
insert into PdbBranches (BranchId,BranchNumber,Name,City,Address,PostalCode) values (3,'103','Wilshire','Los Angeles, CA','Wilshire Blvd','90025');
insert into PdbBranches (BranchId,BranchNumber,Name,City,Address,PostalCode) values (4,'104','Beverly','Los Angeles, CA','Beverly Blvd','90048');
insert into PdbBranches (BranchId,BranchNumber,Name,City,Address,PostalCode) values (5,'105','Century','Los Angeles, CA','Sepulveda Blvd','90045');
insert into PdbBranches (BranchId,BranchNumber,Name,City,Address,PostalCode) values (6,'106','Olympic','Los Angeles, CA','Pico Blvd','90035');
...
insert into PdbRoles (BranchId,Id,Name,RoleType,ParentRoleId) values (4,1,'Manager',1,null);
insert into PdbRoles (BranchId,Id,Name,RoleType,ParentRoleId) values (4,2,'Employee',2,1);
insert into PdbRoles (BranchId,Id,Name,RoleType,ParentRoleId) values (4,3,'Customer',3,null);
...
insert into PdbATMs (BranchId,City,Address,PostalCode) values (1,'Los Angeles, CA','10784 Jefferson Blvd','90189');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (1,'Los Angeles, CA','15135 Sunset Blvd','90189');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (1,'Los Angeles, CA','11611 San Vicente Blvd','90189');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (2,'Los Angeles, CA','18585 Ventura Blvd','90291');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (2,'Los Angeles, CA','11310 National Blvd','90291');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (2,'Los Angeles, CA','8726 Tampa Ave','90291');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (3,'Los Angeles, CA','12401 Wilshire Blvd','90025');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (3,'Los Angeles, CA','1750 Ocean Park Blvd','90025');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (3,'Los Angeles, CA','8653 Beverly Blvd','90025');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (4,'Los Angeles, CA','8750 Sepulveda Blvd','90045');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (4,'Los Angeles, CA','10784 Jefferson Blvd','90045');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (5,'Los Angeles, CA','13405 Washington Blvd','90292');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (5,'Los Angeles, CA','10784 Jefferson Blvd','90230');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (6,'Los Angeles, CA','9618 Pico Blvd','90035');
insert into PdbATMs (BranchId,City,Address,PostalCode) values (6,'Los Angeles, CA','5701 Eastern Ave','90040');
...
if object_id('getATMsNoBranchPU','P') is not null drop procedure getATMsNoBranchPU
go 
create procedure getATMsNoBranchPU-- 
as
begin
	select City,Address,PostalCode
	from PdbATMs ATMs
...
exec getATMs;
exec getATMsPU;
exec getATMsNoBranchPU;
exec PdbgetATMsPU;
exec PdbgetATMsNoBranchPU;
